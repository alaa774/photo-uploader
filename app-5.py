...
app = Flask(__name__)
app.secret_key = os.environ.get("FLASK_SECRET_KEY", "photo-uploader-secret")
...
def get_drive_service():
    ...
    try:
        ...
        print("Drive authentication error:", repr(e))
        return None
...
def auth_google():
    ...
    # Save OAuth state and PKCE verifier across the Google redirect.
...
def oauth2callback():
    ...
    try:
        ...
        return "حدث خطأ أثناء ربط Google Drive. راجع Logs في Render.", 500
    ...
    <body>
        <div class="success">تم ربط Google Drive بنجاح ✅</div>
    </body>
    </html>
    """
